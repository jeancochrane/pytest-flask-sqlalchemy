...
Forked from https://github.com/jeancochrane/pytest-flask-sqlalchemy, in order to allow nested transactions (see https://github.com/GoProperly/pytest-flask-sqlalchemy/pull/1)
